...
def Calculate_metrics(predict_y_proba,train_feature_matrix,train_label_vector,test_feature_matrix, test_label_vector):
...
def cross_validation_experiment(gene_dis_matrix,dis_chemical_matrix,gene_chemical_matrix,gene_gene_matrix,seed,ratio = 1):
    ...
    for train, test in kf.split(row_index):
        ...
        metric += Calculate_metrics(predict_y_proba,train_feature_matrix,train_label_vector,test_feature_matrix, test_label_vector)
        # k_count+=1
...
if __name__=="__main__":
    ...
    dis_chemical_matrix = np.loadtxt('data/dis-chem.csv', delimiter=',', dtype=int)
    gene_chemical_matrix = np.loadtxt('data/gene-chem.csv', delimiter=',', dtype=int)
